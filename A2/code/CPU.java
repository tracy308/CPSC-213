  ...
  @Override protected void execute () throws InvalidInstructionException, MachineHaltException, RegisterSet.InvalidRegisterNumberException, MainMemory.InvalidAddressException
  {
    switch (insOpCode.get()) {
      ...
      case 0x2: // ld (rs, ri, 4), rd .... 2sid
        reg.set (insOp2.get(), mem.readInteger (reg.get(insOp1.get()) + (insOpImm.get() << 2)));
        break;
      ...
      case 0x4: // st rs, (rd, ri, 4) .... 4sdi
        mem.writeInteger ((insOpImm.get() << 2) + reg.get(insOp2.get()), reg.get (insOp0.get()));
        break;
      case 0x6: // ALU ................... 6-sd
        switch (insOp0.get()) {
      ...
      case 0x7: // sh[rl] $i,rd ............. 7dii
        if (insOpImm.get() > 0) {
          // shl $i,rd ............. 7dii
            reg.set(insOp2.get(), insOp2.get() << insOpImm.get());
        } else {
          // shr $i,rd ............. 7dii
