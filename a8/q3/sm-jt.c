...
int exec() {
  int cont = 1;
  int addr, val;
  static const void* insOpCodeJumpTable[16] = { &&L0, &&L1, &&L2, &&L3, &&L4, &&L6, 
  &&L7, &&L8, &&L9, &&L10, &&L11, &&L12, &&L13, &&L14, &&L15, &&DEFAULT};

  static const void* insOp0JumpTable[16] = { &&L60, &&L61, &&L62, &&L63, &&L64, &&L65, &&L66, 
  &&L67, &&L6F, &&DEFAULT1};

  if(insOpCode < 0 || insOpCode == 5 || insOpCode > 15) goto DEFAULT;
  
  if(insOpCode < 5)
        goto *insOpCodeJumpTable[insOpCode];
    
  if(insOpCode > 5)
        goto *insOpCodeJumpTable[insOpCode - 1];
      ...
      L4: // st rs, (rd, ri, 4) .... 4sdi
        ...
        goto CONT;
      L6: // ALU ................... 6-sd
          if (insOp0 < 0 || insOp0 > 8 && insOp0 < 15 || insOp0 > 15) goto DEFAULT1;
          if (insOp0 == 15) goto L6F;
